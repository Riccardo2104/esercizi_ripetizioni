...
public class Auto extends Veicoli {
    ...
    public Auto(String nome_veicolo, int prezzo_base, Year anno_immatricolazione, String tipo_veicolo, String nome_modello){
    ...
    public Auto(String nome_veicolo, int prezzo_base, Year anno_immatricolazione, String tipo_veicolo, String nome_modello , int tasso_deprezzamento){
        this.nome_veicolo = nome_veicolo;
        this.prezzo_base = prezzo_base;
        this.anno_immatricolazione = anno_immatricolazione;
        this.tipo_veicolo = tipo_veicolo;
    ...
    public Auto(String nome_veicolo, int prezzo_base, Year anno_immatricolazione, int costo_assicurazione, String tipo_veicolo, String nome_modello , int tasso_deprezzamento){
        this.nome_veicolo = nome_veicolo;
        this.prezzo_base = prezzo_base;
        this.anno_immatricolazione = anno_immatricolazione;
    ...
    public int getPrezzo() {
        ...
        if (tipo_veicolo.contains("elettrico") && prezzo_aggiornato < 5000) {
            prezzo_aggiornato = prezzo_aggiornato + prezzo_aggiornato*20/100;
        }
        else {
            prezzo_aggiornato = 5000 - prezzo_aggiornato;
        }
