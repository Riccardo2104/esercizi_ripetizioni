...
public class Main {
    ...
    public static boolean TestAggiungiLibro(){
      ...
      * */
        ...
        bibliotecav2.Libro libroPrimoLevi = new Libro("Se questo è un uomo", 200,
...
//      libriTitoli.add(libroIMalavoglia.getTitoloLibro());
    ...
    void prendiInPrestitoTest() {
        ...
        * */
        ...
        Biblioteca biblioteca = new Biblioteca("Biblioteca Mattei", "Via Gallani 42 Milano",libriNonPrestito);
    ...
    void restituisciLibroTest() {
        ...
        Biblioteca biblioteca = new Biblioteca("Biblioteca Mattei", "Via Gallani 42 Milano",libriinPrestito);
